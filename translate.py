...
def create_model(session, forward_only, beam_search, beam_size, attention=False):
...
def train():
  ...
  with tf.Session(config=config) as sess:
    ...
    model = create_model(sess, False, False, data_processor.beam_size, attention=FLAGS.attention)
...
def decode():
  with tf.Session() as sess:
    ...
    model = create_model(sess, True, False, data_processor.beam_size, attention=FLAGS.attention)
