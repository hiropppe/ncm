...
from my_seq2seq import embedding_attention_seq2seq, embedding_rnn_seq2seq, \
    decode_model_with_buckets, model_with_buckets
...
class Seq2SeqModel(object):
  ...
  def __init__(self,
    ...
    def cell():
        if num_layers > 1:
            return tf.contrib.rnn.MultiRNNCell([single_cell() for _ in range(num_layers)], state_is_tuple=False)
        else:
            return single_cell()
    """
